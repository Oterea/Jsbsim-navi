    ...
    with make_vec_env(
        ...
        with wandb.init(
            ...
            if continue_training:
                ...
                checkpoint = "04_29_15_42_time_2048000_steps.zip" # 不用zip后缀
                ...
                model = PPO("MlpPolicy", vec_env, tensorboard_log="runs", verbose=1) # verbose print loss etc. in terminal. 指定tensorboard_log wandb才会同步损失等信息
